...
- **Project 7: [DevOps Tooling Website Solution](https://github.com/lappiahnuamah/DevOps-CloudEngr-StegHub/tree/main/7.DevOps_Tooling_Website_Solution)** - In this project, I walk you through setting up three stateless web servers that share a common database and access to the same files using Network File System (NFS) as a shared file storage. 
