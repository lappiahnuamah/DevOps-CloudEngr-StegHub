...
- **Project 7: [DevOps Tooling Website Solution](https://github.com/lappiahnuamah/DevOps-CloudEngr-StegHub/tree/main/7.DevOps_Tooling_Website_Solution)** - In this project, I successfully set up storage infrastructure on two Linux servers (RHEL 9), and implemented a basic web solution using WordPress
